...
const OUTFIELD_STATS = [
  ["goals_per_90", "attack"], ["xg_per_90", "attack"], ["npxg_per_90", "attack"],
  ["assists_per_90", "attack"], ["xa_per_90", "attack"], ["goals_involved_per_90", "attack"],
  ["shots_per_90", "attack"], ["shots_on_target_per_90", "attack"], ["shot_accuraccy_percentage", "attack"],
  ["passes_per_90", "passing"], ["passes_completed_per_90", "passing"], ["pass_completion_rate", "passing"],
  ["key_passes_per_90", "passing"], ["crosses_per_90", "passing"], ["accurate_crosses_per_90", "passing"],
  ["cross_completion_rate", "passing"],
  ["dribbles_per_90", "dribble"], ["dribbles_successful_per_90", "dribble"], ["dribbled_past_per_90", "dribble"],
  ["tackles_per_90", "defense"], ["interceptions_per_90", "defense"], ["blocks_per_90", "defense"],
  ["clearances_per_90", "defense"], ["aerial_duels_won_per_90", "defense"], ["duels_per_90", "defense"],
  ["duels_won_per_90", "defense"],
];
